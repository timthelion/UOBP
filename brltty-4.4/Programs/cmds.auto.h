...
,
{
  .name = "SHIFT",
  .code = BRL_CMD_SHIFT,
  .description = strtext("add shift modifier to next typed character or emulated key")
}
,
{
  .name = "UPPER",
  .code = BRL_CMD_UPPER,
  .description = strtext("add upper modifier to next typed character or emulated key")
}
,
{
  .name = "CONTROL",
  .code = BRL_CMD_CONTROL,
  .description = strtext("add control modifier to next typed character or emulated key")
}
,
{
  .name = "META",
  .code = BRL_CMD_META,
  .description = strtext("add meta modifier to next typed character or emulated key")
}
,
{
  .name = "TIME",
