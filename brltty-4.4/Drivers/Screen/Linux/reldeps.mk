...
screen.$O: $(SRC_TOP)Programs/ascii.h
screen.$O: $(SRC_TOP)Programs/log.h
screen.$O: $(SRC_TOP)Programs/device.h
screen.$O: $(SRC_TOP)Programs/parse.h
screen.$O: $(SRC_TOP)Programs/system.h
screen.$O: $(SRC_TOP)Programs/sys_linux.h
screen.$O: $(SRC_TOP)Programs/charset.h
screen.$O: $(SRC_TOP)Programs/lock.h
screen.$O: $(SRC_TOP)Programs/brldefs.h
screen.$O: $(SRC_TOP)Programs/driver.h
screen.$O: $(SRC_TOP)Programs/ktbdefs.h
